function [xt_Advect,yt_Advect,zt_Advect] = AdvctForStatic(cpu_num,tSave_Advect,tArr_Advect,xq,yq,zq,time,v,inputMesh)
dt = tArr_Advect(2) - tArr_Advect(1); Nt = numel(tArr_Advect);

% Project the points at initial time
