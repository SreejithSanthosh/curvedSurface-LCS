...
hold on; cmocean('balance','pivot',0);  colorbar('southoutside'); axis equal; shading interp;  axis off;
...
subplot(1,4,3)
trisurf(Tri_pts_Uni,x0,y0,z0,log(detdelF_vert),'FaceAlpha',1,'Edgecolor','none');
cmocean('balance','pivot',0);colorbar('southoutside'); axis equal; shading interp;  axis off;
view(viewAngle); camva(7);
